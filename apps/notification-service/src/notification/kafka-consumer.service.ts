...
import { RabbitMQClient } from '@bankcore/messaging';
        ...
        eachMessage: async ({ topic, message }) => {
          ...
          switch (topic) {
            ...
            case 'bankcore.transaction.approved':
              await this.rabbitMQClient.publish('bankcore.notifications.admin', {
            ...
            case 'bankcore.transaction.completed':
              await this.rabbitMQClient.publish(`bankcore.notifications.customer.${payload.customerId}`, {
